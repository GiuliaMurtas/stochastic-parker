...
def plot_global_spectra(sde_run_config, sde_run_config_1):
    """Plot global spectra
    ...
    spl_1 = run_name_1.split("/") # divides "run_name" in spectrum_config.json where it arrives to the symbol "/"
    mhd_run_1 = spl_1[0] # i.e. athena_reconnection_test
    sde_run_1 = spl_1[1] # i.e. reconnection_test_0
...
with open('spectrum_config_1.json', 'r') as file_handler_1:
    config_1 = json.load(file_handler_1)
...
sde_run_config["tmin"] = 1
sde_run_config["tmax"] = 1

## ION 1 ##

sde_run_1 = "transport_H"
run_name_1 = "athena_reconnection/" + mhd_run + "/" + sde_run_1
sde_run_config_1 = config_1[run_name_1]

p0_1 = 0.1
e0_1 = sde_run_config_1["e0"] / (0.5*p0_1**2)
sde_run_config_1["tmin"] = 2
sde_run_config_1["tmax"] = 2

plot_global_spectra(sde_run_config, sde_run_config_1)
